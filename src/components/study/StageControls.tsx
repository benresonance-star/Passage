...
export function StageControls({
  ...
  return (
    <div className="flex-shrink-0 px-4 pb-8 pt-4 space-y-3">
      {/* Stage-specific controls - Fixed height to prevent vertical text shift */}
      <div className="h-12 flex items-center justify-center">
        {stage === "flow" && (
          <div className="flex items-center justify-center gap-3 animate-in fade-in duration-300 w-full">
        ...
        {stage === "cloze" && (
          <div className="flex justify-between gap-2 animate-in slide-in-from-bottom-2 duration-500 w-full">
