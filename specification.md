# Passage - Bible Chapter Memoriser (v3.7.5)
...
- **Soak Intro**: A 3-second introductory screen displaying John 1:1 ("In the beginning was the Word...") with a fade-in/fade-out animation before the meditation begins. Styled to match the app's main meditation sequence (light weight, italic, Cormorant Garamond).
